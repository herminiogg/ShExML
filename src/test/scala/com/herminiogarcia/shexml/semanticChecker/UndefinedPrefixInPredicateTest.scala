...
class UndefinedPrefixInPredicateTest extends AnyFunSuite
  ...
  test("Undefined prefix in a predicate is detected") {
    ...
    assert(error.getEnrichedErrorMessage(example).contains("44:     [1m[4mwiki:[22m[24mname [films.name] ;"))
  }
