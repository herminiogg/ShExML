...
class UndefinedPrefixInSubjectTest extends AnyFunSuite
  ...
  test("Undefined prefix in a subject is detected") {
    ...
    assert(error.getEnrichedErrorMessage(example).contains("43: :Films [1m[4mwiki:[22m[24m[films.id] {"))
  }
