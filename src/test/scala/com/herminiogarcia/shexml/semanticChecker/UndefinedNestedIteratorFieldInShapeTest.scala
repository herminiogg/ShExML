...
class UndefinedNestedIteratorFieldInShapeTest extends AnyFunSuite
  ...
  private val example =
    """
      ...
      |    :appear_on :[films_xml_file.film_xml.actors.nonexistent] ;
      |}
      |
  ...
  test("Undefined nested iterator field in a shape is detected") {
