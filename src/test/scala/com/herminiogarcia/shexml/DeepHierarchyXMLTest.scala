...
class DeepHierarchyXMLTest extends AnyFunSuite with Matchers with RDFStatementCreator {

  private val example =
    """
      PREFIX : <http://example.com/>
      |SOURCE test_file <https://raw.githubusercontent.com/herminiogg/ShExML/bug-%23113/src/test/resources/deepHierarchy.xml>
      |ITERATOR first_tag <xpath: /tags/tag> {
      |    FIELD id <id>
      |    ITERATOR tag <tag> {
      |        FIELD id <id>
      |        ITERATOR tag <tag> {
