...
/**
  ...
  */
class RDFBagTest extends AnyFunSuite with Matchers with RDFStatementCreator {
  ...
  test("Article shape is correctly translated") {
    ...
    output.containsResource(ResourceFactory.createResource("http://www.w3.org/1999/02/22-rdf-syntax-ns#Bag"))
  }
