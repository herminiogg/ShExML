...
/**
  ...
  */
class RDFAltTest extends AnyFunSuite with Matchers with RDFStatementCreator {
  ...
  private val example =
    """
      ...
      |    a ex:Article ;
      |    ex:hasAuthors ex:[labValues.articles.authors.name AS RDFAlt] ;
      |}
    """.stripMargin
  ...
  test("Article shape is correctly translated") {
    ...
    output.containsResource(ResourceFactory.createResource("http://www.w3.org/1999/02/22-rdf-syntax-ns#Alt"))
  }
