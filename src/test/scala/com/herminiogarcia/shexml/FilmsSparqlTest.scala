...
class FilmsSparqlTest extends AnyFunSuite with Matchers with RDFStatementCreator {
  ...
  test("Entity Q166262 is translated correctly") {
    ...
    assert(output.contains(createStatementWithLiteral(prefix, "Q166262", "country", "United States", XSDDatatype.XSDstring)))
