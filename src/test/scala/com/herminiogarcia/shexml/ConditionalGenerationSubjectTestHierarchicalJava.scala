...
class ConditionalGenerationSubjectTestHierarchicalJava extends AnyFunSuite
  ...
  private val example =
    """
      ...
      |FUNCTIONS helper <java: src/test/resources/functions.java>
      ...
      |
      |:FilmsCondGenerationSubject :[films.id IF helper.isBefore2010(films.years.year1)] {
      |    :name [films.name] ;
