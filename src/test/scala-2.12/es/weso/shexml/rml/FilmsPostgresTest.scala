...
class FilmsPostgresTest extends FunSuite with Matchers with RDFStatementCreator with RMLTestConversion {
  ...
  private val example =
    """
      ...
      |SOURCE films_database <jdbc:postgres://localhost/films>
